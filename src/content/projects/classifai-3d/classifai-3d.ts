...
import { CanvasController } from "../canvas-controler";
import { classifai3DControls } from "./classifai-3d.controls";
import {
  createCamera,
  createCameraLight,
  createLights,
...
import { getIntersectionsFromClickPosition, resizeRenderer } from "./utils";

export class Classifai3D extends CanvasController {
