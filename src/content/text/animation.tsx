...
export const animationQuickSummary =
  "A small project showcasing phong shading combined with reflections from an environment map to create a gold material.";
